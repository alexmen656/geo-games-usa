...
const geojsonPath = path.join(__dirname, 'us-states.geojson');
...
const outputPath = path.join(__dirname, 'us-states_split.geojson');
fs.writeFileSync(outputPath, JSON.stringify(newGeojsonData, null, 2));

console.log('GeoJSON processing complete. Output written to states_split.geojson');