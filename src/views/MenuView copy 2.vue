<template>
  <div class="menu-view">
    ...
    <header class="header">
      <h1>USA Geo Games</h1>
      <div class="tabs">
        <button :class="{ active: activeTab === 'games' }" @click="activeTab = 'games'">Games</button>
    ...
    <div v-if="activeTab === 'games'" class="game-selection">
      <div class="game-card" v-for="game in games" :key="game.id">
        ...
        <div class="game-info">
          <button @click="startGame(game.path)">{{ game.name }}</button>
...
export default {
  ...
  data() {
    return {
      activeTab: 'games',
      games: [
        { id: 'game1', name: 'Guess the Way', path: 'game/1', image: 'https://alex.polan.sk/usa-geo-games/assets/game1.jpg' },
        { id: 'game2', name: 'Name All US States', path: 'game/2', image: 'https://alex.polan.sk/usa-geo-games/assets/game2.jpg' },
        { id: 'game3', name: 'CityScope', path: 'game/3', image: 'https://alex.polan.sk/usa-geo-games/assets/game3.jpg' }
      ]
    };
  },
  methods: {
